...
import com.liu.luntan.entity.Page;
...
@Controller
public class FollowController implements LuntanConst {
...
//        eventProducer.fireEvent(event);
        ...
        return LuntanUtil.getJSONString(0, "已关注！");
    }
    ...
    public String unfollow(int entityType, int entityId) {
        ...
        return LuntanUtil.getJSONString(0, "已取消关注!");
    }
